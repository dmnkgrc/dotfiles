...
3. Build a task-specific rubric covering correctness, security, failure handling, maintainability, scope, and proof. Maintainability includes comment noise: comments that restate the code, the test name, or the change description are findings.
