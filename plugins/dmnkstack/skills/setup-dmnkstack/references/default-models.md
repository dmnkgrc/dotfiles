...
Claude Code aliases are `fable` and `opus` with no context-window suffix. Pi uses `fable-5-1@300k` and `opus-5@300k` only while Cursor included API usage remains (`planUsage.apiPercentUsed` below 100). Auto or Composer remaining does not count.
...
how critics: opus-5 @ high, grok-4.6 @ high, gpt-5.6-sol @ high, fable-5.1 @ high
...
arena runners: gpt-5.6-sol @ high, grok-4.6 @ high, opus-5 @ high, fable-5.1 @ high
arena cross-judge pool: opus-5 @ high, grok-4.6 @ high, gpt-5.6-sol @ high, fable-5.1 @ high
