      ...
      formatters = {
        ruff_format = {
          ...
          prepend_args = function()
            if vim.fn.filereadable(vim.fn.getcwd() .. "/.trunk/configs/.ruff.toml") == 1 then
              return { "--config", ".trunk/configs/.ruff.toml" }
            elseif vim.fn.filereadable(vim.fn.getcwd() .. "/.ruff.toml") == 1 then
